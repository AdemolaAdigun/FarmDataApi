...
<head>
    ...
    if ($validator->isValid()) {
     echo "<h1>JSON</h1>";
     echo "<a href='Sunflower.php'> Sunflower <a><br>";
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	theme: "light2",
	title: {
		text: "Cabbage patch Temperatures"
	},
	axisY: {
...
$.getJSON("http://localhost:8080/cabbage.json", addData);
...
<a href="CabbageXML.php"><p>Switch to XML</p></a>
</body>
<?php
    }
?>
